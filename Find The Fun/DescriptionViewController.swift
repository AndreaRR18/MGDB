...
final class DescriptionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let leadingConstranint = titleSectionCustom.leadingAnchor.constraint(
            equalTo: headerView.leadingAnchor,
            constant: 10)
        
        let bottomConstraint = titleSectionCustom.bottomAnchor.constraint(
            equalTo: headerView.bottomAnchor,
            constant: -10)
        
        let widthConstraint = titleSectionCustom.widthAnchor.constraint(
