...
struct NibName {
    static var gameCellTableViewCell: String { return "GameCellTableViewCell" }
    static var coverHDTableViewCell: String { return "CoverHDTableViewCell" }
    static var coverTableViewCell: String { return "CoverTableViewCell" }
    static var summaryTableViewCell: String { return "SummaryTableViewCell" }
    static var companyTableViewCell: String { return "CompanyTableViewCell" }
    ...
    static var releaseDatePlatformTableViewCell: String { return "ReleaseDatePlatformTableViewCell" }
