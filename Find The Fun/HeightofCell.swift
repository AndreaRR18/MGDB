...
func heightFavouriteSectionDescription(_ section: Int,_ game: GameModel) -> CGFloat {
    switch section {
    case 9:
        return 0
    case 0:
...
func heightRowInFavouriteGameDescription(indexPath: IndexPath, gameDescription: GameModel) -> CGFloat {
    switch indexPath.section {
    case 0:
        return 105
    case 1:
